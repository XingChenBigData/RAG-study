...
- [8-4 RAG评价神器：Ragas框架_ev- 笔记](#8-4-rag评价神器：ragas框架-ev笔记)

在这一小节中，我们通过开源的**RAG评估框架RAGAS**进行rag系统的评估。

来了解一下**RAG评估的三个步骤**。首先，我们先来了解一下**RAGAS这个评估框架的一些特点**。
...
来看一下答案相关性指标中生成问题的提示词写法：

提示词里除了要求生成问题之外，还额外让**大语言模型**进行自我判断，判断生成问题的好坏。例如，如果答案是含糊其辞的就给出1，如果是明确的就给出0，并且对含糊其辞做了一些定义。这样做有助于生成比较正确的问题，计算指标的时候只选择那些答案是明确的问题。
